<template>
  <div class="detail-wrap">
    ...
    <div class="mainContain" v-if="loadingLock">
      <div class="firstSection">
        ...
        <div v-if="Object.keys(allDetails.modelInfo).length > 0">
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.modelInfo.brand_name)"
            >
              {{ allDetails.modelInfo.brand_name }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.modelInfo.series_name)"
            >
              {{ allDetails.modelInfo.series_name }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.modelInfo.model_name)"
            >
              {{ allDetails.modelInfo.model_name }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.modelInfo.model_year)"
            >
              {{ allDetails.modelInfo.model_year }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.modelInfo.model_price)"
            >
              {{ allDetails.modelInfo.model_price }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.modelInfo.model_emission_standard)"
            >
              {{ allDetails.modelInfo.model_emission_standard }}
            </div>
          </div>
        </div>
      ...
      <div class="secondSection">
        ...
        <div v-if="Object.keys(allDetails.evaluateInfo).length > 0">
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.evaluateInfo.city_name)"
            >
              {{ allDetails.evaluateInfo.city_name }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.evaluateInfo.reg_date)"
            >
              {{ allDetails.evaluateInfo.reg_date }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.evaluateInfo.mile)"
            >
              {{ allDetails.evaluateInfo.mile }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.evaluateInfo.dealer_buy_price)"
            >
              {{ allDetails.evaluateInfo.dealer_buy_price }}
            </div>
          </div>
          <!-- <div class="rowDetail">
          ...
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.evaluateInfo.dealer_price)"
            >
              {{ allDetails.evaluateInfo.dealer_price }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="viewReport(allDetails.evaluateInfo.report_url)"
              style="color: #169bd5"
            >
              {{ allDetails.evaluateInfo.report_url ? "点击查看" : "" }}
            </div>
          </div>
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.evaluateInfo.report_time)"
            >
      ...
      <div class="thirdSection">
        ...
        <div v-if="Object.keys(allDetails.wholestateInfo).length > 0">
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              v-if="allDetails.wholestateInfo.is_accident_car == '1'"
            >
              是
            </div>
            <div
              class="rowValue"
              v-else-if="allDetails.wholestateInfo.is_accident_car == '0'"
            >
              否
            </div>
          ...
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.wholestateInfo.accident_grade)"
            >
              {{ allDetails.wholestateInfo.accident_grade }}
            </div>
          </div>
          <!-- <div class="rowDetail">
          ...
          <div class="rowDetail">
            ...
            <div
              class="rowValue"
              @click="showToolTip(allDetails.wholestateInfo.report_time)"
            >
              {{ allDetails.wholestateInfo.report_time }}
            </div>
          </div>
        </div>
        <div v-else class="noContain">无</div>
      ...
      <div class="searchBox">
        <van-button type="primary" size="small" @click="evaluationSearch()"
          >估值查询</van-button
        >
        <van-button type="primary" size="small" @click="carSearch()"
          >车况查询</van-button
        >
