...
.triangle {
  ...
  position: absolute;
  right: 0.066667rem /* 5px -> .066667rem */;
  top: 50%;
  transform: translateY (-50%);
}
.mainContent {
  margin: 0.266667rem 0.266667rem /* 20px -> .266667rem */;
  // width: 100%;
  .rowSection {
